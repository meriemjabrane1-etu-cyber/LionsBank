...
export default function Agencies() {
  const [userLocation, setUserLocation] = useState<[number, number]>([33.5731, -7.5898]);
  ...
  const openMapsDirection = (agency: Agency) => {
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <div className="flex flex-col h-[calc(100vh-64px)] bg-[#041F1E] text-white overflow-hidden relative">
        {/* Glow Effects */}
